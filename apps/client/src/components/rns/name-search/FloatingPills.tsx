...
export const FloatingPills: React.FC<FloatingPillsProps> = memo(({ names: propNames }) => {
  ...
  const getAnimationDuration = (animation: string) => {
    switch(animation) {
      case 'gentle-float': return '6s';
      case 'subtle-fade': return '4s';
      case 'soft-glow': return '5s';
      case 'gentle-sway': return '8s';
      case 'breath': return '4.5s';
      case 'zoom-text': return '15s';
      default: return '5s';
    }
  };
