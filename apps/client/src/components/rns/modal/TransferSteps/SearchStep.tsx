...
interface SearchStepProps {
    ...
    ensName?: string;
    nameDetails: string;
   ownerAddress: { full: `0x${string}`; formatted: string };
    address?: `0x${string}`;
    isConnected: boolean;
    handleContinue: () => void;
}
        ...
        <div className="flex flex-col h-full">
            ...
            {!selectedAddress && recipient.trim() === '' ? (
                <div className="flex items-center justify-center flex-col text-gray-500 gap-2 mt-8">
                    ...
                    <p className="text-center">Enter an Ethereum address<br/>to transfer this name to</p>
                </div>
            ) : selectedAddress && (
                <div className="flex items-center gap-3 p-3 border rounded-lg mb-4">
                    ...
                    <div>
                        ...
                        <div className="text-[11px] sm:text-sm text-gray-500">{selectedAddress.address}</div>
                    </div>
                </div>
            )}
            ...
            {nameDetails && ownerAddress.full && ownerAddress.full.toLowerCase() !== address?.toLowerCase() && (
                <div className="mt-2 p-3 bg-yellow-50 text-yellow-700 rounded-lg">
                    <div className="flex items-center gap-2">
                        <AlertTriangle className="w-5 h-5"/>
                    ...
                    <p className="mt-1 text-sm">
                        You don&#39;t have permission to transfer this name.
                    </p>
                </div>
            )}
